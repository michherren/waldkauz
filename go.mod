module github.com/michherren/waldkauz
...
require (
	...
	github.com/redpanda-data/console/backend v0.0.0-20220815132455-1faa0ba497b2
...
require (
	...
	github.com/redpanda-data/redpanda/src/go/rpk v0.0.0-20220816172829-1b4e1ca54c71 // indirect
